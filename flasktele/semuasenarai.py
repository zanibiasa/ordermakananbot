...
# untuk testing db
list_keyboardbutton = [[InlineKeyboardButton(
    'speedmart', callback_data='handler_membeli')]]
...
def array_senarai_makanan(username_kedai):
    ...
    total_senarai_makanan = Makanan.query.filter_by(
        kedai.username == username_kedai).all()
